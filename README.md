...
In 2024, I contributed new materials and a major revision to [_The Rust Programming Language_ book][book], including a new chapter on async programming in Rust and updates for the Rust 2024 Edition. From 2019–2023, I delivered top-notch [TypeScript][ts] support for [LinkedIn][li], including a spec for [Semantic Versioning for TypeScript Types][semver], and drove the [Ember][ember] TypeScript roadmap and significant parts of Ember’s framework roadmap.
